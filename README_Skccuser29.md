...
| 4.[개인]배송이 완료되면 쿠폰 발행이 시작된다. (Async)|![image](https://user-images.githubusercontent.com/42608068/96695286-71481800-13c4-11eb-9f72-6db8cf6c9645.png)|
| 5.고객이 공유차 렌탈을 취소한다.</br>6. 쿠폰 회수가 정상적으로 완료되면 배송 취소가 진행된다. (Sync)</br>7. 배송 취소가 정상적으로 완료되면 결제 취소가 진행된다. (Sync)</br>8.결제 취소도 정상적으로 이어지면 접수가 최종적으로 취소된다. (Async)|![제목없음21](https://user-images.githubusercontent.com/42608068/96580830-d7289700-1313-11eb-985b-aa1036db3e57.png)|
